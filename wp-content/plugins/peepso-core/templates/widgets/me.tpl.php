<?php
if(defined('PEEPSO_DEV_MODE') && 1==PEEPSO_DEV_MODE) { include('developer.php'); }
...
?>
  ...
  <div class="ps-widget--profile__wrapper ps-widget--external">
    ...
    if($instance['user_id'] >0)
    {
      ...
      <!-- Profile Links -->
      <span class="ps-widget--profile__title"><?php echo __('My Profile', 'peepso-core'); ?></span>
...
//                }
      ...
      <?php if (isset($instance['show_community_links']) && $instance['show_community_links'] === 1) { ?>
        <!-- Community Links -->
        <span class="ps-widget--profile__title"><?php echo __('Community', 'peepso-core'); ?></span>
        <div class="ps-widget--profile__menu">
          <?php
