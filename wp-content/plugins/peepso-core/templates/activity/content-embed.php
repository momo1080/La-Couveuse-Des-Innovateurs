...
?><div class="ps-media-video" data-mime-type="<?php echo __($mime_type) ?>">
	...
	<div class="ps-media-thumbnail video-avatar">
		...
		<?php if ($thumbnail['type'] === 'audio') { ?>
			<audio preload="metadata" controls style="width:100%; padding:10px"
					src="<?php echo __($thumbnail['value']) ?>">
	...
	<div class="ps-media-body video-description">
		<div class="ps-media-title">
			<a href="<?php echo __($url); ?>" <?php echo $linkAttr; ?>><?php echo $title; ?></a>
			<small>
				<a href="<?php echo __($url); ?>" <?php echo $linkAttr; ?>><?php echo $site_name; ?></a>
			</small>
		</div>
